...
echo "Building and validating Maven publication $VERSION..."
...
gh release create "$VERSION" \
    --repo renetik/renetik-android-testing \
    --target master \
    --title "$VERSION" \
    --generate-notes

echo "Release created: https://github.com/renetik/renetik-android-testing/releases/tag/$VERSION"
echo "JitPack: https://jitpack.io/#renetik/renetik-android-testing/$VERSION"
